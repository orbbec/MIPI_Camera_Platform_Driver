...
GMSL cameras interface with various deserializer chips such as MAX9296 and MAX96712. Orbbec GMSL cameras support multiple streams including depth, color, IR, and IMU data, but certain usage limitations apply:
