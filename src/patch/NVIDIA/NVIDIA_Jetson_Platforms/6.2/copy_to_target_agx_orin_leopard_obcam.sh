...
sudo cp tegra234-p3737-camera-g300-leopard-obcam-overlay.dtbo /boot/tegra234-p3737-camera-g300-overlay.dtbo
...
sudo /opt/nvidia/jetson-io/config-by-hardware.py -n 2="Jetson Orbbec Camera G335Lg obcam"
sudo depmod
