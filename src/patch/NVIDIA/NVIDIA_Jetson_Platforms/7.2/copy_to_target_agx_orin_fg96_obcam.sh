...
sudo cp tegra234-p3737-camera-g300-fg96-obcam-thin-overlay.dtbo /boot/tegra234-p3737-camera-g300-overlay.dtbo
...
sudo cp obcam.ko /lib/modules/${KVER}/updates/drivers/media/i2c/
